RSpec.describe "Static pages" do
  it "shows the homepage" do
    ...
    expect(response.body).to include("Find out more about making child arrangements")
  end

  it "shows the arbitration page" do
    get arbitration_path
    expect(response).to be_successful
    expect(response.body).to include("In family arbitration, you and the other person choose a qualified")
    expect(response.body).to include("Find out more about making child arrangements")
  end
  ...
  it "shows the negotiating between parents page" do
    ...
    expect(response.body).to include("Get information on making a parenting plan")
  end
  ...
  it "shows the parental responsibility page" do
    ...
    expect(response.body).to include("Find out more about parental rights and responsibilities")
  end
  ...
  it "shows the professional mediation page" do
    ...
    expect(response.body).to include("Find out how to use mediation to make an agreement without going to court")
  end
